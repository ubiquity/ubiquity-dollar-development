...
import { ensureERC1155Allowance } from "src/pages/components/lib/contracts-shortcuts";
import { DebtCoupon, ERC1155Ubiquity } from "src/contracts/dollar/artifacts/types";
        ...
        <div className="grid gap-4">
            <div className="flex">
                <select
                    ...
                    className="outline-accent/75 mr-2 block h-10 rounded-md border border-solid border-white/40 bg-white/10 p-2 outline-2 focus-visible:outline"
                >
                ...
                <div className="relative">
                    ...
                    <div
                        onClick={() => setMax()}
                        className="hover:border-accent hover:text-accent hover:drop-shadow-accent absolute right-0  top-[50%] mr-2 flex translate-y-[-50%] cursor-pointer items-center rounded-md border border-solid border-white bg-black/80 px-1 text-xs text-white"
                    >
                        MAX
                    </div>
                </div>
