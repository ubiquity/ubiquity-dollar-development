...
import { Icon, Container } from "src/pages/components/ui";
    ...
    return (
        <Container className="w-96">
            <div className="flex flex-col items-center justify-center text-center">
                <div className="text-accent mb-8 flex w-96 flex-col items-center justify-center opacity-50">
...
const ConditionalHeader = ({ show }: { show: boolean }) => (
    <Link href="/">
        <a
            className={cx(
                "hover:text-accent hover:drop-shadow-light -mt-20 box-content flex h-12 items-center justify-center pt-6 uppercase tracking-widest transition duration-300 ease-in-out",
