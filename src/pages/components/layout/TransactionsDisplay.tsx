import { useTransactionLogger, Transaction } from "src/pages/components/lib/hooks";
...
export const Transacting = (props: { transaction: Transaction; onDismiss: () => void }): JSX.Element | null => {
    ...
    return (
        <div className="border-accent bg-accent text-accent mt-1 rounded-full border border-solid bg-opacity-10 py-1 px-4">
