...
import { useBalances, useManagerManaged, useNamedContracts } from "src/pages/components/lib/hooks";
import icons from "src/pages/components/ui/icons";
import useWeb3 from "src/pages/components/lib/hooks/useWeb3";
...
const Inventory = () => {
    ...
    return (
        <div className="border-accent/60 bg-paper pointer-events-auto max-w-screen-lg translate-y-[65%] rounded-t-lg border border-b-0 border-solid transition-transform duration-500 ease-out hover:translate-y-0">
...
const Token = ({
    ...
    return (
        <div className="font-mono text-xs">
            <div className="flex">
                <div className="text-accent relative mr-2 flex w-6 flex-shrink-0 items-center">
                    {<Svg />}
                    <Tippy
                        content={
                            <div className="bg-paper rounded-md border border-solid border-white/10 px-4 py-2 text-sm" style={{ backdropFilter: "blur(8px)" }}>
                    ...
                    >
                        <div
                            ...
                            className="border-accent bg-paper text-accent absolute flex h-full w-full cursor-pointer items-center justify-center rounded-md border border-solid opacity-0 hover:opacity-100"
                        >
                            +
                        </div>
                    </Tippy>
