...
export const Container = (props: React.PropsWithChildren<{ className?: string }>): JSX.Element => (
    <div
      ...
      ${props.className || ""}`}
    >
        <div className="from-accent/90 via-accent/50 to-accent/70 w-full rounded-lg bg-gradient-to-br p-[1px]">
            <div className="bg-paper  rounded-[0.46rem] p-8">{props.children}</div>
        </div>
    </div>
);
