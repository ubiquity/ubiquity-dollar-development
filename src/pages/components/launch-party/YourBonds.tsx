...
const YourBonds = ({
    ...
    return (
        <widget.Container>
                ...
                <table className="m-0 w-full border-collapse">
                    ...
                    {bonds.length > 0 ? (
                        <tbody>
                            {bonds.map((bond, i) => (
                                <tr key={i}>
                                    <td className="whitespace-nowrap border-0 border-r border-solid border-white border-opacity-10 py-2 px-2">
                                        {bond.tokenName}
                                    </td>
            ...
            <div className="text-accent drop-shadow-light mb-6 text-center text-3xl">
