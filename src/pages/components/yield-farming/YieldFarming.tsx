...
import { constrainStringNumber, performTransaction } from "src/pages/components/lib/utils";
import withLoadedContext, { LoadedContext } from "src/pages/components/lib/withLoadedContext";
import { Button, Container, Icon, icons, MaxButtonWrapper, PositiveNumberInput, SubTitle, Title, Tooltip, WalletNotConnected } from "src/pages/components/ui";
        ...
        return (
            <>
                ...
                <span className="pl-4">{tvl.usdc}M</span>
                    ...
                    <div className="w-1/2">
                        <div className="text-accent text-center text-3xl font-bold">{Math.round(maxApy() * 100) / 100}%</div>
                ...
                <div className="mb-4 flex items-center justify-between">
                    <div className="w-5/12 bg-center bg-no-repeat" style={{ backgroundImage: `url('data:image/svg+xml;utf8,${icons.stringsCyan.ubq}')` }}>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-accent flex w-2/12 flex-col items-center justify-center text-center">
                ...
                <span className="pl-4">{tvl.uad}M</span>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-accent flex flex-col items-center justify-center text-center">
