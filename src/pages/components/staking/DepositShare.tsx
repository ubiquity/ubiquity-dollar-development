...
import { constrainNumber } from "src/pages/components/lib/utils";
import { ManagedContracts } from "src/pages/components/lib/hooks/contracts/useManagerManaged";
...
const DepositShare = ({ onStake, disabled, maxLp, managedContracts: contracts }: DepositShareProps) => {
    ...
    return (
        <div>
            <div className="text-accent mb-4 text-center text-3xl opacity-75">
