import { ICurveFactory__factory, DebtCouponManager__factory, YieldProxy__factory, IJar__factory, ERC20__factory } from "src/contracts/dollar/artifacts/types";
import useWeb3, { PossibleProviders } from "../useWeb3";

import NAMED_ACCOUNTS from "src/fixtures/named-accounts.json";
import dollarDeployments from "src/fixtures/contracts-addresses/dollar.json";
