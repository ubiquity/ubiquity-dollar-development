...
import * as widget from "src/components/ui/widget";
import withLoadedContext, { LoadedContext } from "src/components/lib/withLoadedContext";
import { formatTimeDiff, constrainNumber } from "src/components/lib/utils";
import { useBalances, Balances, useTransactionLogger } from "src/components/lib/hooks";
                    ...
                    {leftPositioned ? (
                        <>
                            ...
                            >
                                <svg
                                    ...
                                    className="ml-2 h-6 w-6 text-accent"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
                        ...
                        <>
                            ...
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="mr-2 h-6 w-6 self-end text-accent"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
