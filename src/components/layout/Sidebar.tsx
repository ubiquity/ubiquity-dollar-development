...
import { Icon, IconsNames } from "src/components/ui";
        ...
        <>
            ...
            >
                ...
                {state === "hidden" || state === "hidden_hovering" ? (
                    <a
                        className={cx(
                            "absolute top-[50%] left-full ml-[1px] flex items-center justify-center rounded-r border border-l-0 border-solid border-accent/60 ",
                            {
