...
import { ChainId, Route, Pair, Trade, Token, TokenAmount, TradeType } from "@uniswap/sdk";
...
task("token", "Get info about tokens").setAction(async (taskArgs: { receiver: string; manager: string }, { ethers }) => {
