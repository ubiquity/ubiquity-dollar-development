...
const accountWithWithdrawableBond = "0x0000CE08fa224696A819877070BF378e8B131ACF";

task("deployYieldProxyLocally", "Deploy YieldProxy to the current hardhat running node")
  .addOptionalParam("manager", "The address of uAD Manager")
  .setAction(async (taskArgs: { receiver: string | null; manager: string | null }, { ethers, getNamedAccounts }) => {
